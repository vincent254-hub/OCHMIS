...
{				?>	
		...
		<a href="manage-vehicles.php?del=<?php echo $result->id;?>" onclick="return confirm('Are you sure you want to delete this vehicle?');"><i class="fa fa-close text-danger"></i></a>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
