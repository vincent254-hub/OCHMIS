...
<head>
	...
	<title>OCHMIS |Admin Vehicle Management Page   </title>
...
{				?>	
		...
		<td><a href="edit-vehicle.php?id=<?php echo $result->id;?>"><i class="fa fa-edit text-success"></i></a>&nbsp;&nbsp;
<a href="manage-vehicles.php?del=<?php echo $result->id;?>" onclick="return confirm('Are you sure you want to delete this vehicle?');"><i class="fa fa-close text-danger"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
